// nios2_tristate_conduit_pin_sharer_0.v

// This file was auto-generated from altera_tristate_conduit_pin_sharer_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 13.0sp1 232 at 2022.10.09.10:12:28

`timescale 1 ps / 1 ps
module nios2_tristate_conduit_pin_sharer_0 (
		input  wire        clk_clk,                        //   clk.clk
		input  wire        reset_reset,                    // reset.reset
		output wire        request,                        //   tcm.request
		input  wire        grant,                          //      .grant
		output wire [21:0] ext_flash_tcm_address_out,      //      .ext_flash_tcm_address_out_out
		...
		output wire [7:0]  ext_flash_tcm_data_out,         //      .ext_flash_tcm_data_out_out
		input  wire [7:0]  ext_flash_tcm_data_in,          //      .ext_flash_tcm_data_out_in
		output wire        ext_flash_tcm_data_outen,       //      .ext_flash_tcm_data_out_outen
	...
	nios2_tristate_conduit_pin_sharer_0_pin_sharer pin_sharer (
		.clk                            (clk_clk),                        //      clk.clk
		.reset                          (reset_reset),                    //    reset.reset
		.request                        (request),                        //      tcm.request
		.grant                          (grant),                          //         .grant
		.ext_flash_tcm_address_out      (ext_flash_tcm_address_out),      //         .ext_flash_tcm_address_out_out
		...
		.ext_flash_tcm_data_out         (ext_flash_tcm_data_out),         //         .ext_flash_tcm_data_out_out
		.ext_flash_tcm_data_in          (ext_flash_tcm_data_in),          //         .ext_flash_tcm_data_out_in
		.ext_flash_tcm_data_outen       (ext_flash_tcm_data_outen),       //         .ext_flash_tcm_data_out_outen
	...
	nios2_tristate_conduit_pin_sharer_0_arbiter arbiter (
		.clk         (clk_clk),                   //       clk.clk
